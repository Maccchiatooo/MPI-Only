...
void LBM::pack()
{
    if (z_lo != 0)
    {
        for (int j = 0; j < ly; j++)
        {
            for (int i = 0; i < lx; i++)
            {
                ...
                {
                    m_downout[ii + i * q + j * lx * q] = f[ii + i * q + ghost * q * lx * ly + j * q * lx];
                }
            }
        }
    }
    ...
    if (z_hi != glz - 1)
    {
        for (int j = 0; j < ly; j++)
        {
            for (int i = 0; i < lx; i++)
            {
                for (int ii = 0; ii < q; ii++)
                {
                    m_upout[ii + i * q + j * lx * q] = f[ii + i * q + (lz - ghost - 1) * q * lx * ly + j * q * lx];
                }
            }
        }
    }
    if (y_lo != 0)
    {
        for (int k = 0; k < lz; k++)
        {
            for (int i = 0; i < lx; i++)
            {
                for (int ii = 0; ii < q; ii++)
                {
                    m_frontout[ii + i * q + k * lx * q] = f[ii + i * q + ghost * q * lx + k * q * lx * ly];
                }
            }
        }
    }
    if (y_hi != gly - 1)
    {
        for (int k = 0; k < lz; k++)
        {
            for (int i = 0; i < lx; i++)
            {
                for (int ii = 0; ii < q; ii++)
                {
                    m_backout[ii + i * q + k * lx * q] = f[ii + i * q + (ly - ghost - 1) * q * lx + k * q * lx * ly];
                }
            }
        }
    }
        ...
        for (int k = 0; k < lz; k++)
        {
            for (int j = 0; j < ly; j++)
            {
                ...
                for (int ii = 0; ii < q; ii++)
                {
                    ...
                    m_leftout[ii + j * q + k * q * ly] = f[ii + l_s[0] * q + j * q * lx + k * q * lx * ly];
                }
            }
        }
    }
        ...
        for (int k = 0; k < lz; k++)
        {
            for (int j = 0; j < ly; j++)
            {
                ...
                for (int ii = 0; ii < q; ii++)
                {
                    ...
                    m_rightout[ii + j * q + k * q * ly] = f[ii + (l_e[0] - 1) * q + j * q * lx + k * q * lx * ly];
                }
            }
        }
    }
    ...
    if (x_lo != 0 && z_hi != glz - 1)
    {
        for (int j = 0; j < l_l[1]; j++)
        {
            for (int ii = 0; ii < q; ii++)
            {
                m_leftupout[ii + j * q] = f[ii + l_s[0] * q + (j + l_s[1]) * q * lx + (l_e[2] - 1) * q * lx * ly];
            }
        }
    }
    ...
    if (x_hi != glx - 1 && z_hi != glz - 1)
    {
        for (int j = 0; j < l_l[1]; j++)
        {
            for (int ii = 0; ii < q; ii++)
            {
                ...
                m_rightupout[ii + j * q] = f[ii + (l_e[0] - 1) * q + (j + l_s[1]) * q * lx + (l_e[2] - 1) * q * lx * ly];
            }
        }
    }
    ...
    if (x_lo != 0 && z_lo != 0)
    {
        for (int j = 0; j < l_l[1]; j++)
        {
            for (int ii = 0; ii < q; ii++)
            {
                m_leftdownout[ii + j * q] = f[ii + (l_s[0]) * q + (j + l_s[1]) * q * lx + l_s[2] * q * lx * ly];
            }
        }
    }
    ...
    if (x_hi != glx - 1 && z_lo != 0)
    {
        for (int j = 0; j < l_l[1]; j++)
        {
            for (int ii = 0; ii < q; ii++)
            {
                m_rightdownout[ii + j * q] = f[ii + (l_e[0] - 1) * q + (j + l_s[1]) * q * lx + l_s[2] * q * lx * ly];
            }
        }
    }
    ...
    if (y_lo != 0 && z_hi != glz - 1)
    {
        for (int i = 0; i < l_l[0]; i++)
        {
            for (int ii = 0; ii < q; ii++)
            {
                m_frontupout[ii + i * q] = f[ii + (i + l_s[0]) * q + l_s[1] * q * lx + (l_e[2] - 1) * q * lx * ly];
            }
        }
    }
    ...
    if (y_lo != 0 && z_lo != 0)
    {
        for (int i = 0; i < l_l[0]; i++)
        {
            for (int ii = 0; ii < q; ii++)
            {
                m_frontdownout[ii + i * q] = f[ii + (i + l_s[0]) * q + l_s[1] * q * lx + l_s[2] * q * lx * ly];
            }
        }
    }
    ...
    if (y_hi != gly - 1 && z_hi != glz - 1)
    {
        for (int i = 0; i < l_l[0]; i++)
        {
            for (int ii = 0; ii < q; ii++)
            {
                m_backupout[ii + i * q] = f[ii + (i + l_s[0]) * q + (l_e[1] - 1) * q * lx + (l_e[2] - 1) * q * lx * ly];
            }
        }
    }
    ...
    if (y_hi != gly - 1 && z_lo != 0)
    {
        for (int i = 0; i < l_l[0]; i++)
        {
            for (int ii = 0; ii < q; ii++)
            {
                m_backdownout[ii + i * q] = f[ii + (i + l_s[0]) * q + (l_e[1] - 1) * q * lx + l_s[2] * q * lx * ly];
            }
        }
    }
    ...
    if (x_lo != 0 && y_lo != 0)
    {
        for (int k = 0; k < l_l[2]; k++)
        {
            for (int ii = 0; ii < q; ii++)
            {
                m_frontleftout[ii + k * q] = f[ii + l_s[0] * q + l_s[1] * q * lx + (k + l_s[2]) * q * lx * ly];
            }
        }
    }
    ...
    if (x_hi != glx - 1 && y_lo != 0)
    {
        for (int k = 0; k < l_l[2]; k++)
        {
            for (int ii = 0; ii < q; ii++)
            {
                m_frontrightout[ii + k * q] = f[ii + (l_e[0] - 1) * q + l_s[1] * q * lx + (k + l_s[2]) * q * lx * ly];
            }
        }
    }
    ...
    if (x_lo != 0 && y_hi != gly - 1)
    {
        for (int k = 0; k < l_l[2]; k++)
        {
            for (int ii = 0; ii < q; ii++)
            {
                m_backleftout[ii + k * q] = f[ii + l_s[0] * q + (l_e[1] - 1) * q * lx + (k + l_s[2]) * q * lx * ly];
            }
        }
    }
    ...
    if (x_hi != glx - 1 && y_hi != gly - 1)
    {
        for (int k = 0; k < l_l[2]; k++)
        {
            for (int ii = 0; ii < q; ii++)
            {
                m_backrightout[ii + k * q] = f[ii + (l_e[0] - 1) * q + (l_e[1] - 1) * q * lx + (k + l_s[2]) * q * lx * ly];
            }
        }
    }
    ...
    if (x_lo != 0 && z_lo != 0 && y_lo != 0)
    {
        for (int ii = 0; ii < q; ii++)
        {
            m_frontleftdownout[ii] = f[ii + l_s[0] * q + l_s[1] * q * lx + l_s[2] * q * lx * ly];
        }
    }
    ...
    if (x_hi != glx - 1 && z_lo != 0 && y_lo != 0)
    {
        for (int ii = 0; ii < q; ii++)
        {
            m_frontrightdownout[ii] = f[ii + (l_e[0] - 1) * q + l_s[1] * q * lx + l_s[2] * q * lx * ly];
        }
    }
    ...
    if (x_lo != 0 && z_lo != 0 && y_hi != gly - 1)
    {
        for (int ii = 0; ii < q; ii++)
        {
            m_backleftdownout[ii] = f[ii + l_s[0] * q + (l_e[1] - 1) * q * lx + l_s[2] * q * lx * ly];
        }
    }
    ...
    if (x_hi != glx - 1 && z_lo != 0 && y_hi != gly - 1)
    {
        for (int ii = 0; ii < q; ii++)
        {
            m_backrightdownout[ii] = f[ii + (l_e[0] - 1) * q + (l_e[1] - 1) * q * lx + l_s[2] * q * lx * ly];
        }
    }
    ...
    if (x_lo != 0 && z_hi != glz - 1 && y_lo != 0)
    {
        for (int ii = 0; ii < q; ii++)
        {
            m_frontleftupout[ii] = f[ii + l_s[0] * q + l_s[1] * q * lx + (l_e[2] - 1) * q * lx * ly];
        }
    }
    ...
    if (x_hi != glx - 1 && z_hi != glz - 1 && y_lo != 0)
    {
        for (int ii = 0; ii < q; ii++)
        {
            m_frontrightupout[ii] = f[ii + (l_e[0] - 1) * q + l_s[1] * q * lx + (l_e[2] - 1) * q * lx * ly];
        }
    }
    ...
    if (x_lo != 0 && z_hi != glz - 1 && y_hi != gly - 1)
    {
        for (int ii = 0; ii < q; ii++)
        {
            m_backleftupout[ii] = f[ii + l_s[0] * q + (l_e[1] - 1) * q * lx + (l_e[2] - 1) * q * lx * ly];
        }
    }
    ...
    if (x_hi != glx - 1 && z_hi != glz - 1 && y_hi != gly - 1)
    {
        for (int ii = 0; ii < q; ii++)
        {
            m_backrightupout[ii] = f[ii + (l_e[0] - 1) * q + (l_e[1] - 1) * q * lx + (l_e[2] - 1) * q * lx * ly];
        }
    }
    MPI_Barrier(MPI_COMM_WORLD);
}
void LBM::exchange()
{
    int mar = 1;
    if (y_lo != 0)
        MPI_Send(m_frontout, lx * q * lz, MPI_DOUBLE, comm.front, mar, comm.comm);

    if (y_hi != gly - 1)
        MPI_Recv(m_back, lx * q * lz, MPI_DOUBLE, comm.back, mar, comm.comm, MPI_STATUSES_IGNORE);

    mar = 2;
    if (y_hi != gly - 1)
        MPI_Send(m_backout, lx * q * lz, MPI_DOUBLE, comm.back, mar, comm.comm);

    if (y_lo != 0)
        MPI_Recv(m_front, lx * q * lz, MPI_DOUBLE, comm.front, mar, comm.comm, MPI_STATUSES_IGNORE);

    mar = 3;
    if (z_lo != 0)
        MPI_Send(m_downout, lx * q * ly, MPI_DOUBLE, comm.down, mar, comm.comm);

    if (z_hi != glz - 1)
        MPI_Recv(m_up, lx * q * ly, MPI_DOUBLE, comm.up, mar, comm.comm, MPI_STATUSES_IGNORE);

    mar = 4;
    if (z_hi != glz - 1)
        MPI_Send(m_upout, lx * q * ly, MPI_DOUBLE, comm.up, mar, comm.comm);

    if (z_lo != 0)
        MPI_Recv(m_down, lx * q * ly, MPI_DOUBLE, comm.down, mar, comm.comm, MPI_STATUSES_IGNORE);
...
void LBM::unpack()
{
    if (y_hi != gly - 1)
    {
        for (int k = 0; k < lz; k++)
        {
            for (int i = 0; i < lx; i++)
            {
                for (int ii = 0; ii < q; ii++)
                {
                    f[ii + i * q + (ly - ghost) * q * lx + k * q * lx * ly] = m_back[ii + i * q + k * lx * q];
                }
            }
        }
    }
    if (y_lo != 0)
    {
        for (int k = 0; k < lz; k++)
        {
            for (int i = 0; i < lx; i++)
            {
                for (int ii = 0; ii < q; ii++)
                {
                    f[ii + i * q + (ghost - 1) * q * lx + k * q * lx * ly] = m_front[ii + i * q + k * lx * q];
                }
            }
        }
    }
    ...
    if (z_lo != 0)
    {
        for (int j = 0; j < ly; j++)
        {
            for (int i = 0; i < lx; i++)
            {
                for (int ii = 0; ii < q; ii++)
                {
                    f[ii + i * q + (ghost - 1) * q * lx * ly + j * q * lx] = m_down[ii + i * q + j * lx * q];
                }
            }
        }
    }
    ...
    if (z_hi != glz - 1)
    {
        for (int j = 0; j < ly; j++)
        {
            for (int i = 0; i < lx; i++)
            {
                for (int ii = 0; ii < q; ii++)
                {
                    f[ii + i * q + (lz - ghost) * q * lx * ly + j * q * lx] = m_up[ii + i * q + j * lx * q];
                }
            }
        }
    }
    ...
    if (x_lo != 0)
    {
        for (int k = 0; k < lz; k++)
        {
            for (int j = 0; j < ly; j++)
            {
                ...
                for (int ii = 0; ii < q; ii++)
                {
                    f[ii + (l_s[0] - 1) * q + j * q * lx + k * q * lx * ly] = m_left[ii + j * q + k * q * ly];
                }
            }
        }
    }
    ...
    if (x_hi != glx - 1)
    {
        for (int k = 0; k < lz; k++)
        {
            for (int j = 0; j < ly; j++)
            {
                for (int ii = 0; ii < q; ii++)
                {
                    f[ii + l_e[0] * q + j * q * lx + k * q * lx * ly] = m_right[ii + j * q + k * q * ly];
                }
            }
        }
    }
    if (x_hi != glx - 1 && z_lo != 0)
    {
        for (int j = 0; j < l_l[1]; j++)
        {
            for (int ii = 0; ii < q; ii++)
            {
                f[ii + l_e[0] * q + (j + l_s[1]) * q * lx + (l_s[2] - 1) * q * lx * ly] = m_rightdown[ii + j * q];
            }
        }
    }
    ...
    if (x_hi != glx - 1 && z_hi != glz - 1)
    {
        for (int j = 0; j < l_l[1]; j++)
        {
            for (int ii = 0; ii < q; ii++)
            {
                ...
                f[ii + l_e[0] * q + (j + l_s[1]) * q * lx + l_e[2] * q * lx * ly] = m_rightup[ii + j * q];
            }
        }
    }
    ...
    if (x_lo != 0 && z_hi != glz - 1)
    {
        for (int j = 0; j < l_l[1]; j++)
        {
            for (int ii = 0; ii < q; ii++)
            {
                ...
                f[ii + (l_s[0] - 1) * q + (j + l_s[1]) * q * lx + l_e[2] * q * lx * ly] = m_leftup[ii + j * q];
            }
        }
    }
    ...
    if (x_lo != 0 && z_lo != 0)
    {
        for (int j = 0; j < l_l[1]; j++)
        {
            for (int ii = 0; ii < q; ii++)
            {
                ...
                f[ii + (l_s[0] - 1) * q + (j + l_s[1]) * q * lx + (l_s[2] - 1) * q * lx * ly] = m_leftdown[ii + j * q];
            }
        }
    }
    ...
    if (y_hi != gly - 1 && z_lo != 0)
    {
        for (int i = 0; i < l_l[0]; i++)
        {
            for (int ii = 0; ii < q; ii++)
            {
                ...
                f[ii + (i + l_s[0]) * q + l_e[1] * q * lx + (l_s[2] - 1) * q * lx * ly] = m_backdown[ii + i * q];
            }
        }
    }
    ...
    if (y_hi != gly - 1 && z_hi != glz - 1)
    {
        for (int i = 0; i < l_l[0]; i++)
        {
            for (int ii = 0; ii < q; ii++)
            {
                ...
                f[ii + (i + l_s[0]) * q + l_e[1] * q * lx + l_e[2] * q * lx * ly] = m_backup[ii + i * q];
            }
        }
    }
    ...
    if (y_lo != 0 && z_lo != 0)
    {
        for (int i = 0; i < l_l[0]; i++)
        {
            for (int ii = 0; ii < q; ii++)
            {
                ...
                f[ii + (i + l_s[0]) * q + (l_s[1] - 1) * q * lx + (l_s[2] - 1) * q * lx * ly] = m_frontdown[ii + i * q];
            }
        }
    }
    ...
    if (y_lo != 0 && z_hi != glz - 1)
    {
        for (int i = 0; i < l_l[0]; i++)
        {
            for (int ii = 0; ii < q; ii++)
            {
                ...
                f[ii + (i + l_s[0]) * q + (l_s[1] - 1) * q * lx + l_e[2] * q * lx * ly] = m_frontup[ii + i * q];
            }
        }
    }
    ...
    if (x_hi != glx - 1 && y_hi != gly - 1)
    {
        for (int k = 0; k < l_l[2]; k++)
        {
            for (int ii = 0; ii < q; ii++)
            {
                ...
                f[ii + l_e[0] * q + l_e[1] * q * lx + (k + l_s[2]) * q * lx * ly] = m_backright[ii + k * q];
            }
        }
    }
    ...
    if (x_lo != 0 && y_hi != gly - 1)
    {
        for (int k = 0; k < l_l[2]; k++)
        {
            for (int ii = 0; ii < q; ii++)
            {
                ...
                f[ii + (l_s[0] - 1) * q + l_e[1] * q * lx + (k + l_s[2]) * q * lx * ly] = m_backleft[ii + k * q];
            }
        }
    }
    ...
    if (x_hi != glx - 1 && y_lo != 0)
    {
        for (int k = 0; k < l_l[2]; k++)
        {
            for (int ii = 0; ii < q; ii++)
            {
                ...
                f[ii + l_e[0] * q + (l_s[1] - 1) * q * lx + (k + l_s[2]) * q * lx * ly] = m_frontright[ii + k * q];
            }
        }
    }
    ...
    if (x_lo != 0 && y_lo != 0)
    {
        for (int k = 0; k < l_l[2]; k++)
        {
            for (int ii = 0; ii < q; ii++)
            {
                ...
                f[ii + (l_s[0] - 1) * q + (l_s[1] - 1) * q * lx + (k + l_s[2]) * q * lx * ly] = m_frontleft[ii + k * q];
            }
        }
    }
    if (x_lo != 0 && z_lo != 0 && y_lo != 0)
    {
        for (int ii = 0; ii < q; ii++)
        {
            f[ii + (l_s[0] - 1) * q + (l_s[1] - 1) * q * lx + (l_s[2] - 1) * q * lx * ly] = m_frontleftdown[ii];
        }
    }
    ...
    if (x_hi != glx - 1 && z_lo != 0 && y_lo != 0)
    {
        for (int ii = 0; ii < q; ii++)
        {
            f[ii + l_e[0] * q + (l_s[1] - 1) * q * lx + (l_s[2] - 1) * q * lx * ly] = m_frontrightdown[ii];
        }
    }
    ...
    if (x_lo != 0 && z_lo != 0 && y_hi != gly - 1)
    {
        for (int ii = 0; ii < q; ii++)
        {
            f[ii + (l_s[0] - 1) * q + l_e[1] * q * lx + (l_s[2] - 1) * q * lx * ly] = m_backleftdown[ii];
        }
    }
    ...
    if (x_hi != glx - 1 && z_lo != 0 && y_hi != gly - 1)
    {
        for (int ii = 0; ii < q; ii++)
        {
            f[ii + l_e[0] * q + l_e[1] * q * lx + (l_s[2] - 1) * q * lx * ly] = m_backrightdown[ii];
        }
    }
    ...
    if (x_lo != 0 && z_hi != glz - 1 && y_lo != 0)
    {
        for (int ii = 0; ii < q; ii++)
        {
            f[ii + (l_s[0] - 1) * q + (l_s[1] - 1) * q * lx + l_e[2] * q * lx * ly] = m_frontleftup[ii];
        }
    }
    ...
    if (x_hi != glx - 1 && z_hi != glz - 1 && y_lo != 0)
    {
        for (int ii = 0; ii < q; ii++)
        {
            f[ii + l_e[0] * q + (l_s[1] - 1) * q * lx + l_e[2] * q * lx * ly] = m_frontrightup[ii];
        }
    }
    ...
    if (x_lo != 0 && z_hi != glz - 1 && y_hi != gly - 1)
    {
        for (int ii = 0; ii < q; ii++)
        {
            f[ii + (l_s[0] - 1) * q + l_e[1] * q * lx + l_e[2] * q * lx * ly] = m_backleftup[ii];
        }
    }
    ...
    if (x_hi != glx - 1 && z_hi != glz - 1 && y_hi != gly - 1)
    {
        for (int ii = 0; ii < q; ii++)
        {
            f[ii + l_e[0] * q + l_e[1] * q * lx + l_e[2] * q * lx * ly] = m_backrightup[ii];
        }
    }
}